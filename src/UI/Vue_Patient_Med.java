...
public class Vue_Patient_Med extends javax.swing.JFrame {
     ...
     */
    public Vue_Patient_Med(Connection conn, DPI dpi, PH ph) throws SQLException, ClassNotFoundException {
        initComponents();
        this.conn = conn;
        this.dpi = dpi;
        this.ph = ph;
    ...
    private void initComponents() {
        ...
        Panel_BandeauLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, Panel_BandeauLayout.createSequentialGroup()
                ...
                .addComponent(Panel_logo, javax.swing.GroupLayout.PREFERRED_SIZE, 160, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
    ...
    private void jLabel14MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel14MouseClicked
        Ajout_FS i = new Ajout_FS(conn, ph, null, dpi, null);
        i.setVisible(true);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        Ajout_FS i;
        i = new Ajout_FS(conn, ph, null, dpi, null);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            HL7_SIH_Serveur hl;
            hl = new HL7_SIH_Serveur(conn, 6588); //4445
