...
public class Modif_Patient extends javax.swing.JFrame {
     ...
     */
    public Modif_Patient(Connection conn, SecretaireAdministrative sa, SecretaireMedicale sm, DPI dpi) {
        this.conn = conn;
        this.dpi = dpi;
        this.sa = sa;
        this.sm = sm;
        ...
        } else switch (dpi.getSexe()) {
            case femme -> RadioButton_F2.setSelected(true);
            case homme -> RadioButton_H2.setSelected(true);
    ...
    private void initComponents() {
        ...
        jButton3.setText("Modifier un medecin traitant");
